...
/**
 * (1): Deal 8(11) Damage. Next turn, gain 1 Energy.
 *  @author NITRO
 *  @version 1.0
 *  @since 2020-07-16
 */
public class RedGun extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(RedGun.class.getSimpleName());
    public static final String IMG = makeCardPath("Attacks/redgun.jpg");
