 ...
 *  @since 2020-07-16
 */
public class TeleportsAbove extends AbstractChaosControlCard {
    ...
    public static final String ID = DefaultMod.makeID(TeleportsAbove.class.getSimpleName());
    public static final String IMG = makeCardPath("Attacks/teleportabove.jpg");
