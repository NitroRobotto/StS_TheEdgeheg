...
import theEdgeheg.cards.attacks.guns.RocketLauncher;
...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("theEdgehegResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("theEdgehegResources/images/powers/placeholder_power32.png");
    ...
    public void atStartOfTurn() { // At the start of your turn
        AbstractCard playCard = new RocketLauncher(); // Declare Card - the RocketLauncher card. We will name it 'playCard'.
